    ...
    en: {
      translation: {
        ...
        ownerHome: {
          ...
          completeSetup: "Complete Business Setup",
          switchToCustomer: "Switch to Customer Account",
          switchToCustomerConfirmTitle: "Switch to Customer Account?",
          switchToCustomerConfirmBody: "You'll lose access to business owner features. You can switch back if you create a business later.",
          switchToCustomerConfirm: "Yes, Switch",
          switchToCustomerCancel: "Stay as Owner",
        ...
        profile: {
          ...
          deleteAccountSectionTitle: "Danger Zone",
          deleteAccountDesc: "Permanently delete your account. Your personal information will be removed but appointment history is kept anonymously.",
          deleteAccountConfirmTitle: "Delete your account?",
          deleteAccountConfirmBody: "This is permanent and cannot be undone. Type DELETE to confirm.",
        ...
        dashboard: {
          ...
          messageFollowers: "Message Followers",
          messageFollowersDesc: "Reach {{count}} follower",
          messageFollowersDesc_other: "Reach {{count}} followers",
          messageFollowersDescNone: "Send a message to your followers",
        },

        broadcast: {
          pageTitle: "Broadcast Messages",
          pageSubtitle: "Send messages to all your followers",
          sendButton: "Send Message",
          modalTitle: "New Broadcast",
          viewBusinessPage: "View Business Page",
          titleLabel: "Title",
          titlePlaceholder: "e.g. Special offer this weekend!",
          bodyLabel: "Message",
          bodyPlaceholder: "Write your message here…",
          recipientPreview_one: "This will be sent to {{count}} follower",
          recipientPreview_other: "This will be sent to {{count}} followers",
          recipientPreviewNone: "You have no followers yet — this message won't be sent.",
          sendSuccess: "Message sent to {{count}} follower",
          sendSuccess_other: "Message sent to {{count}} followers",
          rateLimitError: "You've reached today's broadcast limit. Try again after {{time}}.",
          rateLimitBanner: "{{remaining}} of {{limit}} messages remaining today",
          rateLimitExhausted: "Daily limit reached. Resets {{time}}.",
          historyTitle: "Broadcast History",
          historyEmpty: "No broadcasts sent yet. Use 'Send Message' to reach your audience.",
          sentTo_one: "Sent to {{count}} follower",
          sentTo_other: "Sent to {{count}} followers",
          loadMore: "Load more",
          sending: "Sending…",
          chars: "{{current}}/{{max}}",
        },
        ...
        businessSchedule: {
          ...
          manuallyBlockedSlot: "Manually blocked slot",
          noBlockNote: "No reason provided",
          clickToBlock: "Click to block this slot",
          blockThisSlot: "Block this slot?",
          blockNotePlaceholder: "Reason (optional)",
          blockSlot: "Block Slot",
          unblockSlot: "Unblock",
          blocking: "Blocking…",
          unblocking: "Unblocking…",
          blockFailed: "Failed to block slot. It may have been booked.",
          unblockFailed: "Failed to unblock slot. Please try again.",
    ...
    he: {
      translation: {
        ...
        ownerHome: {
          ...
          completeSetup: "השלם הגדרת עסק",
          switchToCustomer: "עבור לחשבון לקוח",
          switchToCustomerConfirmTitle: "לעבור לחשבון לקוח?",
          switchToCustomerConfirmBody: "תאבד גישה לתכונות בעל עסק. תוכל לחזור אם תיצור עסק בעתיד.",
          switchToCustomerConfirm: "כן, עבור",
          switchToCustomerCancel: "הישאר כבעל עסק",
          businessSubtitle: "{{name}}",
        ...
        profile: {
          ...
          deleteAccountSectionTitle: "אזור מסוכן",
          deleteAccountDesc: "מחק את חשבונך לצמיתות. המידע האישי שלך יוסר אך היסטוריית הפגישות נשמרת באנונימיות.",
          deleteAccountConfirmTitle: "למחוק את החשבון?",
          deleteAccountConfirmBody: "פעולה זו בלתי הפיכה. הקלד מחק לאישור.",
          deleteAccountConfirmPlaceholder: "הקלד מחק לאישור",
          deleteAccountConfirm: "מחק את חשבוני",
        ...
        dashboard: {
          ...
          messageFollowers: "הודעה לעוקבים",
          messageFollowersDesc: "הגע אל {{count}} עוקב",
          messageFollowersDesc_other: "הגע אל {{count}} עוקבים",
          messageFollowersDescNone: "שלח הודעה לעוקבים שלך",
        },

        broadcast: {
          pageTitle: "הודעות שידור",
          pageSubtitle: "שלח הודעות לכל העוקבים שלך",
          sendButton: "שלח הודעה",
          modalTitle: "שידור חדש",
          viewBusinessPage: "צפה בדף העסק",
          titleLabel: "כותרת",
          titlePlaceholder: "למשל: מבצע מיוחד בסוף השבוע!",
          bodyLabel: "הודעה",
          bodyPlaceholder: "כתוב את הודעתך כאן…",
          recipientPreview_one: "זה יישלח אל {{count}} עוקב",
          recipientPreview_other: "זה יישלח אל {{count}} עוקבים",
          recipientPreviewNone: "אין לך עוקבים עדיין — ההודעה לא תישלח.",
          sendSuccess: "הודעה נשלחה אל {{count}} עוקב",
          sendSuccess_other: "הודעה נשלחה אל {{count}} עוקבים",
          rateLimitError: "הגעת למגבלת השידורים היומית. נסה שוב אחרי {{time}}.",
          rateLimitBanner: "{{remaining}} מתוך {{limit}} הודעות נותרו היום",
          rateLimitExhausted: "המגבלה היומית הושגה. מתאפס {{time}}.",
          historyTitle: "היסטוריית שידורים",
          historyEmpty: "לא נשלחו שידורים עדיין. השתמש ב'שלח הודעה' כדי להגיע לקהל שלך.",
          sentTo_one: "נשלח אל {{count}} עוקב",
          sentTo_other: "נשלח אל {{count}} עוקבים",
          loadMore: "טען עוד",
          sending: "שולח…",
          chars: "{{current}}/{{max}}",
        },
        ...
        businessSchedule: {
          ...
          manuallyBlockedSlot: "תור חסום ידנית",
          noBlockNote: "לא סופקה סיבה",
          clickToBlock: "לחץ לחסימת תור זה",
          blockThisSlot: "לחסום תור זה?",
          blockNotePlaceholder: "סיבה (אופציונלי)",
          blockSlot: "חסום תור",
          unblockSlot: "בטל חסימה",
          blocking: "חוסם…",
          unblocking: "מבטל חסימה…",
          blockFailed: "חסימת התור נכשלה. ייתכן שהוזמן.",
          unblockFailed: "ביטול חסימת התור נכשל. נסה שוב.",
          blockedLabel: "חסום",
