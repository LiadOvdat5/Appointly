...
interface MetricDef {
  ...
  getSubtext: (r: CustomerReportDTO) => string;
}
...
const METRIC_DEFS: MetricDef[] = [
  {
    ...
    getSubtext: (r) => (r.totalBookings === 1 ? "appointment" : "appointments"),
  },
  {
...
const DEFAULT_METRICS: MetricKey[] = ["totalBookings", "totalSpent", "favBusiness"];
      ...
      <div className="bg-white dark:bg-surface-dark border-b border-gray-200 dark:border-gray-800 px-4 py-4">
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">{authUser?.name ?? "Customer"}</p>
          </div>
        </div>
      </div>
        ...
        <section>
          ...
          {reportLoading ? (
            ...
            <div className="flex flex-col items-center gap-3 py-10 text-center">
              ...
              <p className="text-sm text-gray-400">Select metrics above to display your activity</p>
            </div>
          ) : (
            <div className="space-y-3">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                <p className="font-bold text-[#111418] dark:text-white text-sm">My Appointments</p>
                <p className="text-xs text-gray-500 mt-0.5">View, manage &amp; cancel bookings</p>
              </div>
            ...
            >
              ...
              <div>
                <p className="font-bold text-[#111418] dark:text-white text-sm">Discover Businesses</p>
                <p className="text-xs text-gray-500 mt-0.5">Find and book new services</p>
              </div>
              <MaterialIcon name="chevron_right" className="text-gray-400 ml-auto shrink-0" />
            </button>
            ...
            >
              ...
              <div>
                <p className="font-bold text-[#111418] dark:text-white text-sm">My Profile</p>
