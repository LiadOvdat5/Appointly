...
## Acceptance Criteria
- [ ] Follower count is visible to all users on the public business page
- [ ] Follower count is shown as a summary stat in the Business Dashboard
- [ ] Count updates in real time (or near real time) after a follow/unfollow event
