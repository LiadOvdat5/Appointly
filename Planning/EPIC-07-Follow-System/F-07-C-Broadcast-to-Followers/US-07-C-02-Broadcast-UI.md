...
## Acceptance Criteria
- [x] Owner can compose and send a broadcast in under 5 taps/clicks
- [x] Character limits are enforced client-side with real-time feedback
- [x] Rate-limit state is shown clearly — no silent failures
- [x] Notification bell handles `BusinessBroadcast` type without errors (icon + correct link)
- [x] Followers who receive the notification see the business name, message title, and body in the notification list
