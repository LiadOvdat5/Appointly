...
## Acceptance Criteria
- [x] Downloaded `.ics` file imports correctly into Apple Calendar
- [x] Downloaded `.ics` file imports correctly into Outlook
- [x] Event details match the appointment (time, duration, title, location)
- [x] UID is unique per appointment (use appointmentId in the UID field)
