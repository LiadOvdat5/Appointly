...
- `[BE]` Add a database seeder (or EF Core data seed) that creates one admin user (`admin@appointly.com`, strong hashed password, role = `admin`) if none exists — seeded at startup
