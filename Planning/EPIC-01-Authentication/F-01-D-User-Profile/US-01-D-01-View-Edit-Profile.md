...
## Acceptance Criteria
- [x] User can update their name and email without changing their password
- [x] Password change requires the current password to be entered and confirmed
- [x] Changes are persisted immediately and reflected in the UI after save
- [x] Validation errors (e.g., email already taken) are shown inline
